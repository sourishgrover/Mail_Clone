...
const Inbox = () => {
    ...
    return (
        <div className='flex-1 bg-white rounded-xl mx-5 sm:block w-20  '>
            <div className='flex items-center justify-between px-4'>
                <div className='flex items-center gap-2 text-gray-700 py-2'>
                    ...
                    <div className='p-2 rounded-full hover:bg-gray-100 cursor-pointer sm:block hidden'>
                ...
                <div className='flex items-center gap-2'>
                    <p className='text-sm text-gray-500 sm:font-[10px]'>1-50 of {emails?.length}</p>
